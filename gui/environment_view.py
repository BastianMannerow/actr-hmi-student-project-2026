...
class EnvironmentView(QFrame):
    ...
    def _build_legend(self) -> QWidget:
        ...
        row.setSpacing(14)
        row.addWidget(self._legend_item("#475569", "X", "Known wall"))
        row.addWidget(self._legend_item("#7f1d1d", "W", "Wall"))
        row.addWidget(self._legend_item("#854d0e", "P", "Passable obstacle"))
        row.addWidget(self._legend_item("#16a34a", "T", "Target"))
